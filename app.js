...
function handleLocalSignup(e) {
  ...
  if (existingUser) {
    showAppMessage("An account with this email already exists! Please log in instead.", "Email Exists");
    return false;
  }
...
function confirmSpriteSelection() {
  ...
  if (selectedSpriteStaticTemp.includes('female')) {
